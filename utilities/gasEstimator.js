 ...
 * @param storeOnChain
 */
function estimateGas(path, ethPriceInUsd = ETH_PRICE_IN_USD, gasPriceGwei = GAS_PRICE_GWEI, storeOnChain = false) {
    try {
        // Read the file
...
estimateGas('../HomomorphicEncryption/companySetupData.json', ETH_PRICE_IN_USD, GAS_PRICE_GWEI, storeOnChain);
estimateGas('../HomomorphicEncryption/studentData.json', ETH_PRICE_IN_USD, GAS_PRICE_GWEI, storeOnChain);
estimateGas('../ZKP/verificationKey.json', ETH_PRICE_IN_USD, GAS_PRICE_GWEI, storeOnChain);
estimateGas('../ZKP/proof.json', ETH_PRICE_IN_USD, GAS_PRICE_GWEI, storeOnChain);
